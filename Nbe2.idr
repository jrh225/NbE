...
mutual
    ...
    data TypeValue = VPi Mult TypeValue TypeClosure | VSigma Mult TypeValue TypeClosure | VBool | VUnit | VEl Value | VTypeNeu TypeNeu | VSet
    data TypeNeu = NEl Neu
...
mutual
    ...
    readBackNormal ctx (VTypeNeu _) _ = Nothing -- Precondition
